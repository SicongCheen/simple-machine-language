...
/**
 * This class represents a mul instruction.
 *
...
public final class MulInstruction extends Instruction {
     ...
     */
    public MulInstruction(String label, int rResult, int r1, int r2) {
        super(label, "mul");
    ...
    /**
     * Executes the mul instruction, probably modifying the registers.
     *
